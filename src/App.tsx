function App() {
  return (
    <main className="min-h-screen bg-indigo-200">
      <div className="min-h-screen flex flex-col lg:flex-row max-lg:pb-16 max-w-[1800px] mx-auto bg-red-200">
        <section className="shrink-0 space-y-4 lg:space-y-8 lg:w-[350px] xl:w-[500px] p-6 lg:p-16 lg:pr-0 xl:pr-16 bg-blue-200">
              ...
              <li>
                ...
                >
                  <span className="transform duration-200 group-hover:scale-110 fill-base-content">
                    ...
                    >
                      <title
                        data-testid="svgTitle"
                        id="title_0.7989023227237741"
                      >
                        twitter
                      </title>
        ...
        <section className="lg:h-screen lg:overflow-scroll noscrollbar w-full max-w-[1500px] bg-slate-100">
          <div className="divider px-6 my-0 lg:hidden " />
      ...
      <div className="fixed bottom-4 max-lg:right-4 lg:bottom-16 lg:left-16 select-none">
        <div className="px-3 py-1.5 bg-neutral text-neutral-content flex items-center gap-1 rounded-lg text-sm cursor-pointer shadow-lg group hover:scale-[1.02] hover:shadow-xl duration-200">
          ...
          <div className="font-medium">
            ...
            <span className="hidden md:inline">Build your</span> Indie Page
          </div>
        </div>
      </div>
    </main>
